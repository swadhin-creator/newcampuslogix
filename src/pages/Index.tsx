...
import collegeStudentsImage from "@assets/study-abroad-us-canada-or-uk.jpg_1767461655820.webp";
  ...
  return <div>
      ...
      <section className="bg-section-alt section-padding">
        <div className="container-main">
          ...
          }].map((item, index) => <div key={index} className="rounded-xl border border-border bg-card p-6 shadow-card transition-shadow hover:shadow-card-hover">
      ...
      <section className="bg-section-alt section-padding">
        <div className="container-main">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-4">
            ...
            step: "01",
            title: "Consultation",
            description: "We understand your institution's needs, student profile, and goals."
          }, {
            step: "02",
            title: "Customization",
            description: "Programs are tailored to align with your curriculum and timeline."
          }, {
            step: "03",
            title: "Delivery",
            description: "Expert trainers deliver engaging, hands-on training sessions."
          }, {
            step: "04",
            title: "Assessment",
            description: "Regular evaluations and progress reports keep you informed."
          }].map((item, index) => <div key={index} className="relative text-center">
      ...
      <section className="section-padding">
        <div className="container-main">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            description: "Content designed by practitioners with real-world relevance."
          }, {
            icon: Users,
            title: "Expert Trainers",
            description: "Experienced professionals who know how to engage students."
          }, {
            icon: Lightbulb,
            title: "Project-Based Learning",
            description: "Hands-on projects that build practical, demonstrable skills."
          }, {
            icon: BarChart3,
            ...
            description: "Programs designed to fit your academic calendar."
          }].map((item, index) => <div key={index} className="flex gap-4 rounded-xl border border-border bg-card p-5 shadow-card transition-shadow hover:shadow-card-hover">
      ...
      <section className="bg-primary section-padding">
        <div className="container-main">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <Button size="lg" variant="secondary" className="mt-8" onClick={openLeadForm}>
              Schedule a Consultation
              <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
          </div>
...
const FAQSection = () => {
  ...
  return <section className="bg-section-alt section-padding">
      <div className="container-main">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="heading-2 text-foreground">Frequently Asked Questions</h2>
        </div>
        <div className="mx-auto mt-12 max-w-3xl space-y-4">
          {faqs.map((faq, index) => <div key={index} className="rounded-xl border border-border bg-card shadow-card">
              <button className="flex w-full items-center justify-between p-5 text-left" onClick={() => setOpenIndex(openIndex === index ? null : index)}>
                <span className="font-medium text-foreground">{faq.question}</span>
                {openIndex === index ? <ChevronUp className="h-5 w-5 flex-shrink-0 text-muted-foreground" /> : <ChevronDown className="h-5 w-5 flex-shrink-0 text-muted-foreground" />}
              </button>
              {openIndex === index && <div className="border-t border-border px-5 pb-5 pt-4">
